...
import { Package, RefreshCw, Search, Upload } from "lucide-react";
...
function OrderRow({ order, index }: { order: Order; index: number }) {
  ...
  return (
    <motion.div
      ...
      className="flex flex-col md:flex-row md:items-stretch rounded-lg border bg-card hover:shadow-sm hover:border-primary/20 cursor-pointer transition-all h-[88px] overflow-hidden"
    >
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center h-14 border-b bg-card shrink-0">
        <div className="flex items-center gap-2 px-3 w-64 shrink-0 border-r h-full">
          ...
          <h2 className="text-sm font-semibold leading-tight flex-1">Treatment Plan</h2>
      ...
      <UploadDrawer
        ...
        title="Upload Design / Upload Plan"
      />
    </div>
  );
}
