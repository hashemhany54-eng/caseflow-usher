...
function OrderRow({ order, index }: { order: Order; index: number }) {
  ...
  return (
    <motion.div
      ...
      className="flex flex-col md:flex-row md:items-stretch rounded-lg border bg-card hover:shadow-sm hover:border-primary/20 cursor-pointer transition-all min-h-[88px]"
    >
